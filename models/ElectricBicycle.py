...
class ElectricBicycle(AbstractBicycle):
    ...
    def __init__(self, type_of_bicycle="None", brand="None", max_speed=0, current_speed=0, capacity_of_battery=0,
    ...
    def get_max_distance(self):
        """Calculate and return the maximum distance the electric bicycle can travel based on the battery capacity."""
    ...
    def __str__(self):
        ...
        return f"ElectricBicycle: type={self.type_of_bicycle}, brand={self.brand}, " \
