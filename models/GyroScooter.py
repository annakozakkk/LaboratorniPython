...
class GyroScooter(AbstractBicycle):
    ...
    def get_max_distance(self):
        """  Calculate and return the maximum distance the gyro scooter can travel based on battery capacity and voltage."""
    ...
    def __str__(self):
        ...
        return f"GyroScooter: type={self.type_of_bicycle}, brand={self.brand}, " \
               ...
               f"capacity_of_battery={self.capacity_of_battery}, battery_voltage={self.battery_voltage}, " \
